...
// Plant Images
import plant1 from "../assets/images/areca-md.jpg";
import plant2 from "../assets/images/calathiya-md.jpg";
import plant3 from "../assets/images/dieaffenachiya-md.png";
import plant4 from "../assets/images/zz-black.png";
...
import plant8 from "../assets/images/black-rubbert.png";
import plant9 from "../assets/images/zz-md.jpg";
import plant10 from "../assets/images/thuja-md.jpg";
import plant11 from "../assets/images/aglomonia-ice-plant.png";
import plant12 from "../assets/images/calathiya-md.jpg";

// Banner
import bannerBg from "../assets/images/pick-any-four-plant.png";

const plants = [
    { img: plant1, name: "Areca Plant", price: "₹580", rating: 4.5, offer: "35% OFF", size: "Small", sunlight: "Low", water: "Spray" },
    { img: plant2, name: "Calathiya Plant", price: "₹180", rating: 4.3, offer: "45% OFF", size: "Medium", sunlight: "Medium", water: "Often" },
    { img: plant3, name: "Dieffenbachia Plant", price: "₹190", rating: 4.0, offer: "25% OFF", size: "Large", sunlight: "Full", water: "Daily" },
    { img: plant4, name: "ZZ Black Plant", price: "₹290", rating: 4.2, offer: "35% OFF", size: "Small", sunlight: "Low", water: "Spray" },
    ...
    { img: plant8, name: "Black rubbert", price: "₹560", rating: 4.1, offer: "20% OFF", size: "Small", sunlight: "Medium", water: "Spray" },
    { img: plant9, name: "ZZ Green Plant", price: "₹720", rating: 4.8, offer: "50% OFF", size: "Small", sunlight: "Low", water: "Spray" },
    { img: plant10, name: "Aglaonema Ice Plant", price: "₹280", rating: 4.8, offer: "35% OFF", size: "Medium", sunlight: "Medium", water: "Often" },
    { img: plant11, name: "Aglaonema Ice Plant", price: "₹280", rating: 4.8, offer: "25% OFF", size: "Large", sunlight: "Full", water: "Daily" },
    { img: plant12, name: "Calathiya Plan", price: "₹180", rating: 4.8, offer: "30% OFF", size: "Small", sunlight: "Low", water: "Spray" },
];

const MediumPlantCollection = () => {
...
export default MediumPlantCollection;
